...
This is the github repository for a site made by Aaditya Jindal of 10D for Quickbyte competition

This repository has contains a project showing an ecommerce site made by Aaditya Jindal for a company "Banana" that is run by an enterprising minion.
