"""
Django settings for minionfactory project.
...
SECRET_KEY = 'django-secure-rv1fb)bb+g)-79m#a$*bfpfr$tye)wid02m#(kk%v!15obtyej'
...
WSGI_APPLICATION = 'minionfactory.wsgi.application'
